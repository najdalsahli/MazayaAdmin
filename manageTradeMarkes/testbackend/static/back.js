...
function change_page(){
  ...
  document.getElementById('link').val='link';
  document.getElementById('link').href='/ViewTradeMark';
 document.getElementById('link').click();
     };
    }
...
function change_page(){
  document.getElementById('link').val='link';
  document.getElementById('link').href='/tradeMarkInfo';
 document.getElementById('link').click();
  ...
  function deleteTM(uid){
    var region;
      ...
      firebase.database().ref('Regions/'+data.key+'/Trademarks/'+uid).remove();
          });
      });
...
firebase.database().ref('Categories').once("value", function(snapshot) {
  snapshot.forEach(function(data) {
 console.log(data.key);
firebase.database().ref('Categories/'+data.key+'/Trademarks/'+uid).remove();
  });
});
